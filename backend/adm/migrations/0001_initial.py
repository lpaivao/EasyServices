    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rg', models.CharField(blank=True, default=832, max_length=20, unique=True)),
                ('cpf', models.CharField(blank=True, default=359, max_length=14, unique=True)),
                ('data_nascimento', models.DateField(blank=True, default=django.utils.timezone.now)),
                ...
                ('user_type', models.CharField(choices=[('Cliente', 'Cliente'), ('Prestador', 'Prestador')], default='Cliente', max_length=10)),
