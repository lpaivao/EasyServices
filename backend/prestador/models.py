...
class Prestador(AbstractUser):
    ...
    groups = models.ManyToManyField(Group, related_name='prestador_groups', blank=True)
    user_permissions = models.ManyToManyField(Permission, related_name='prestador_user_permissions', blank=True)
